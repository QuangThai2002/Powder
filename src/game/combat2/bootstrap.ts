...
//
// Night Upgrade projectile bridge installs before main.ts so PowView runtime calls
// use the directional source->target adapter without changing combat state logic.
//

...
function installSwitcher(): void {
  ...
  status.textContent = '2.18.3: 9 nghề đều có THƯỜNG / SKILL / ULT riêng. 4 nghề cận chiến tự lao tới mục tiêu, không projectile, không cast phép. QA không damage và không chuyển lượt.';

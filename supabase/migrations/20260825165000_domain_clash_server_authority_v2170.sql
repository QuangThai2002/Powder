...
-- Version-controlled source for the migrations already applied to the Powder Supabase project.
...
before insert or update of match_id,player_a,player_b on public.pvp_domain_clashes_v2170

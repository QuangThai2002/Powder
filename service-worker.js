...
const BOOT_WARM_FIXED="return MANIFEST.filter(a=>a.k==='script'||a.k==='style'||ENTRY_VISUALS.includes(a.u)).every(a=>have.has(a.u))";
const BOOT_QUEUE_BAD='const q=[...MANIFEST],concurrency=';
const BOOT_QUEUE_FIXED="const q=MANIFEST.filter(a=>a.k==='script'||a.k==='style'||ENTRY_VISUALS.includes(a.u)),concurrency=";

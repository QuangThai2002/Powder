...
function buildStages(island){const out=[],count=stageCount(island);for(let n=1;n<=count;n++){
 ...
 const baseStars=starTarget(island.id),recommendedStars=Math.min(7,baseStars+pressure.starBonus),tutorial=island.id===1&&n===1;

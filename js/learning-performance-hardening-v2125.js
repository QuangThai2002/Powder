...
window.POWDER_LEARNING_PERFORMANCE_V2125={version:VERSION,refresh,audit,commandActive,memoryOpen,activateSessionContinuity2126,designReferences:['Kolibri learner UI','Moodle course dashboard','Open edX learner dashboard'],rulesPreserved:'Question pools, Mastery, SRS, rewards, Daily Boss, Rank, Dungeon and Combat unchanged'};

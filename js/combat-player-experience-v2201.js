...
function snapshot(){return{version:VERSION,...state,css:CSS_HREF,presentation:'layout/skill presentation only',timing:'NATIVE — window.setTimeout is never replaced',audio:'NATIVE — POWDER_COMBAT_AUDIO is never muted or replaced',domMutation:'no attack FX nodes are removed during an action',performance:'event-driven + requestAnimationFrame only',gameplayMutation:false,damageFormulaMutation:false,skillDataMutation:false,serverMutation:false,saveMutation:false}}

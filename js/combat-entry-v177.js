...
function syncReadyLaunch(){const b=ensureLaunchButton(),native=document.querySelector('#battleView [data-cv7-launch]'),battle=scene()?.getCore?.(),ready=!!native&&(!battle?.state?.phase||battle.state.phase==='ready');b.hidden=!ready;return ready}

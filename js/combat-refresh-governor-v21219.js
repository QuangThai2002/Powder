...
function activateNext(){if(window.POWDER_SCROLL_PIPELINE_V21220||document.getElementById('powderScrollPipeline21220'))return;const s=document.createElement('script');s.id='powderScrollPipeline21220';s.src='js/scroll-pipeline-v21220.js?v=2207';s.async=true;document.head.appendChild(s)}

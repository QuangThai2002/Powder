...
const VERSION='22.1.0-combat-identity',root=document.documentElement;
...
function collect(reason='event'){
  ...
  root.dataset.performanceDirector=state.status;root.dataset.performanceGoalFps=String(Math.round(hz));root.dataset.performanceHeadroom=String(state.headroom);root.dataset.combatPipeline='identity-2210';
...
function loadCombatRuntimeQaBridge(){return addScript('powderCombatRuntimeQaBridge2140','js/combat-runtime-qa-bridge-v2140.js?v=2210','POWDER_COMBAT_RUNTIME_QA_BRIDGE_V2140')}
...
function activateTurnSafety(){return addScript('powderCombatTurnSafety2207','js/combat-turn-safety-v2207.js?v=2210','POWDER_COMBAT_TURN_SAFETY_V2207')}
function activateStableCombatLayout(){return addScript('powderCombatLayout2200','js/combat-layout-v2200.js?v=2210','POWDER_COMBAT_LAYOUT_V2200')}
function activateStablePlayerExperience(){return addScript('powderCombatPlayerExperience2201','js/combat-player-experience-v2201.js?v=2210','POWDER_COMBAT_PLAYER_EXPERIENCE_V2201')}
function activateRealPlayerBaseline(){return addScript('powderCombatRealPlayerBaseline2205','js/combat-real-player-baseline-v2205.js?v=2210','POWDER_COMBAT_REAL_PLAYER_BASELINE_V2205')}
function activateAncientExclusiveAltar(){return addScript('powderCombatExclusiveAltar2206','js/combat-exclusive-altar-v2206.js?v=2210','POWDER_COMBAT_EXCLUSIVE_ALTAR_V2206')}
function activateCombatIdentityBreakthrough(){return addScript('powderCombatIdentityBreakthrough2210','js/combat-identity-breakthrough-v2210.js?v=2210','POWDER_COMBAT_IDENTITY_BREAKTHROUGH_V2210')}

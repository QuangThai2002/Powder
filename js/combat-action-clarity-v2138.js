...
function clearMarks(m){for(const u of qsa('[data-caf2138-source],[data-caf2138-target],[data-caf2138-current],[data-caf2138-cc],[data-caf2138-impact]',m)){u.removeAttribute('data-caf2138-source');u.removeAttribute('data-caf2138-target');u.removeAttribute('data-caf2138-current');u.removeAttribute('data-caf2138-cc');u.removeAttribute('data-caf2138-impact');u.removeAttribute('aria-current');u.removeAttribute('aria-description')}}
...
for(const u of cc){const lock=u.querySelector('.cv7-cc-lock')?.textContent?.trim().replace(/\s+/g,' ');if(lock)u.setAttribute('aria-description',`Trạng thái khống chế: ${lock}`)}
}

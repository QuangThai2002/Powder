...
function activateNext(){if(window.POWDER_PERFORMANCE_DIRECTOR_V21221||document.getElementById('powderPerformanceDirector21221'))return;const s=document.createElement('script');s.id='powderPerformanceDirector21221';s.src='js/performance-director-v21221.js?v=2205';s.async=true;document.head.appendChild(s)}

...
function boot(){clean();DOC.addEventListener('powder:local-save',clean);window.addEventListener('powder:view-changed',clean,{passive:true})}
window.POWDER_RUNTIME_CLEAN_PRESENTATION_V2129={version:VERSION,clean,injectStyle,rulesPreserved:'Presentation only; gameplay, save, economy, learning, server authority and Combat unchanged'};

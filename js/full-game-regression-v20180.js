...
function diagnostics(){
 ...
 const checks={
  ...
  learningRuntimeConsolidated:!srs||(String(srs.runtimePolicy||'').includes('logic-only')&&!window.POWDER_LEARNING_RUNTIME_RECOVERY_V21210),
  ...
  cloudSave:!!window.POWDER_ONLINE_V150&&(!saveIntegrity||!!saveIntegrity),
  security:!security||!!security,
  performance:(!pressure||String(pressure.mode||'').includes('event-driven'))&&(!!window.POWDER_PERFORMANCE_V1757||!!window.POWDER_PRODUCTION_READINESS_V1910),

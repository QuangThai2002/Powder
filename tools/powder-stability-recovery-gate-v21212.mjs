...
const files={
  skill:read('js/skill-loadout.js'),
  secure:read('js/secure-learning-v176.js'),
  srs:read('js/learning-srs-intelligence-v2114.js'),
  hub:read('js/learning-hub-v149.js'),
  pressure:read('js/adaptive-runtime-pressure-v21011.js'),
  presentation:read('js/combat-presentation-v21015.js'),
  content:read('js/combat-content-ui-v1890.js'),
  entry:read('js/combat-entry-v177.js'),
  progression:read('js/progression-unlocks-v1782.js'),
  domain:read('js/domain-system-v15.js'),
  regression:read('js/full-game-regression-v20180.js'),
  sw:read('service-worker.js'),
  css:read('css/stability-recovery-v21212.css'),
  index:read('index.html')
};

const unwantedLearning=[
  'learning-daily-study-orchestrator-v2115.js',
  'learning-mastery-recovery-v2116.js',
  'learning-daily-rotation-runner-v2119.js',
  'learning-command-center-v2120.js',
  'learning-performance-hardening-v2125.js',
  'learning-session-continuity-v2126.js',
  'admin-learning-event-control-v2127.js',
  'learning-production-v2128.js',
  'runtime-clean-presentation-v2129.js',
  'learning-runtime-recovery-v21210.js',
  'wheel-input-recovery-v21211.js'
];
...
const checks=[
  ...
  check('noCanonicalAudioTouchedByRecoveryCode',!Object.values(files).some((s,i)=>i!==9&&/domain-voice-usercut-[1-4]\.m4a|user-combat-bgm\.mp3/.test(s)))
];

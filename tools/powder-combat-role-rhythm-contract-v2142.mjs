...
const checks={
  ...
  battleCoreMultiHit:role.includes('function nominalHits')&&role.includes('c?.actionInfo?.(u,key)')&&role.includes('function scheduleNominalHits')&&role.includes('nominalHitHints'),
  ...
  coreExposesActionInfo:scene.includes('battle.actionInfo(unit,key)')&&scene.includes('getCore:()=>battle'),

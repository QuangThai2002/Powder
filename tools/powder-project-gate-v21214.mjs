...
check('Combat governor is native-refresh aware',combatRefresh.includes("hz>=180&&ratio<.58")&&combatRefresh.includes("hz>=120&&ratio<.68")&&combatRefresh.includes("data-native-fx-cap")===false&&combatRefresh.includes('nativeFxCap'),'native refresh FX policy missing');
